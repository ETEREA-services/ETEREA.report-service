...
import eterea.report.api.rest.factura.application.service.InvoiceDataService;
import eterea.report.api.rest.factura.domain.model.*;
...
public class FacturaPdfService {
    ...
    public String generatePdf(Long clienteMovimientoId, InvoiceData invoiceData) {
        ...
        if (clienteMovimientoAsociado != null) {
            comprobanteAfipAsociado = clienteMovimientoAsociado.getComprobante().getComprobanteAfip();
        }
        ...
        var comprobanteAfip = comprobante.getComprobanteAfip();
    ...
    private void makePage(String filename, String titulo, Empresa empresa, Comprobante comprobante,
        ...
        try {
            ...
            paragraph.add(new Phrase(Objects.requireNonNull(comprobante.getComprobanteAfip().getComprobanteAfipId()).toString(),
